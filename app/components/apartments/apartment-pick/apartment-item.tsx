...
export const ApartmentItem = ({
  ...
  return (
    <li
      className={clsx(
        "relative mb-4 cursor-pointer transform transition-transform duration-500 ease-in-out rounded-xl",
        {
    ...
    >
      <Card
        className={clsx(
          "flex flex-row transition-colors duration-500 ease-in-out",
          {
      ...
      >
        <div className="relative w-1/3 overflow-hidden rounded-t-lg rounded-l-lg rounded-tr-none">
          {apartment.image ? (
            <img
              src={apartment.image}
              alt={apartment.name}
