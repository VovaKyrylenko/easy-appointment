import {
  useQuery
} from "/build/_shared/chunk-UPE7KI6L.js";
import {
  ChevronLeftIcon,
  ChevronRightIcon,
  ResetIcon,
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id2) => {
    window.$RefreshRuntime$.register(type, '"app/components/ui/badge.tsx"' + id2);
  };
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1725377049456.9944";
}
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  prevRefreshSig = window.$RefreshSig$;
  window.$RefreshReg$ = (type, id2) => {
    window.$RefreshRuntime$.register(type, '"app/components/apartments/apartment-pick/apartment-item.tsx"' + id2);
  };
  window.$RefreshSig$ = window.$RefreshRuntime$.createSignatureFunctionForTransform;
}
var prevRefreshReg;
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("li", { className: clsx_default("relative mb-4 cursor-pointer transform transition-transform duration-500 ease-in-out rounded-xl", {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "relative md:w-1/3 w-full overflow-hidden rounded-t-lg md:rounded-l-lg md:rounded-tr-none", children: [
      apartment.image ? /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("img", { src: apartment.image, alt: apartment.name, className: "object-cover h-full w-full transition-transform duration-500 ease-in-out transform hover:scale-105" }, void 0, false, {
        ...
        lineNumber: 39,
        columnNumber: 30
      }, this) : /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "flex items-center justify-center bg-gray-200 h-full w-full", children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(ImageOff, { className: "w-12 h-12 text-gray-400" }, void 0, false, {
        fileName: "app/components/apartments/apartment-pick/apartment-item.tsx",
        lineNumber: 40,
        columnNumber: 15
      }, this) }, void 0, false, {
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  prevRefreshSig = window.$RefreshSig$;
  window.$RefreshReg$ = (type, id2) => {
    window.$RefreshRuntime$.register(type, '"app/components/apartments/apartment-pick/apartment-list.tsx"' + id2);
  };
  window.$RefreshSig$ = window.$RefreshRuntime$.createSignatureFunctionForTransform;
}
var prevRefreshReg;
...
// app/components/apartments/apartment-pick/apartment-selection-section.tsx
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  prevRefreshSig = window.$RefreshSig$;
  window.$RefreshReg$ = (type, id2) => {
    window.$RefreshRuntime$.register(type, '"app/components/apartments/apartment-pick/apartment-selection-section.tsx"' + id2);
  };
  window.$RefreshSig$ = window.$RefreshRuntime$.createSignatureFunctionForTransform;
}
var prevRefreshReg;
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1725532969757.0542";
}
var ApartmentSelectionSection = ({
  apartments,
  onSelect,
  selectedApartment
}) => {
  const isEmpty = apartments.length === 0;
  return /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "p-6 bg-blue-50 rounded-lg shadow-md flex flex-col h-[75vh] overflow-hidden", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("h2", { className: "text-2xl font-semibold mb-4 text-gray-700", children: "Choose an Apartment" }, void 0, false, {
      fileName: "app/components/apartments/apartment-pick/apartment-selection-section.tsx",
      lineNumber: 29,
      columnNumber: 7
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("p", { className: "mb-6 text-gray-600", children: "Browse through our collection of charming apartments and select the one that suits your needs." }, void 0, false, {
      fileName: "app/components/apartments/apartment-pick/apartment-selection-section.tsx",
      lineNumber: 32,
      columnNumber: 7
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "flex-1 overflow-y-auto", children: isEmpty ? /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "flex items-center justify-center h-full", children: /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("p", { className: "text-gray-500 text-lg", children: "No apartments available" }, void 0, false, {
      fileName: "app/components/apartments/apartment-pick/apartment-selection-section.tsx",
      lineNumber: 39,
      columnNumber: 13
    }, this) }, void 0, false, {
      ...
      lineNumber: 38,
      columnNumber: 20
    }, this) : /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(ApartmentList, { apartments, onSelect, selectedApartment }, void 0, false, {
      fileName: "app/components/apartments/apartment-pick/apartment-selection-section.tsx",
      lineNumber: 40,
      columnNumber: 20
    }, this) }, void 0, false, {
...
_c4 = ApartmentSelectionSection;
var _c4;
$RefreshReg$(_c4, "ApartmentSelectionSection");
window.$RefreshReg$ = prevRefreshReg;
window.$RefreshSig$ = prevRefreshSig;
...
function Navigation(props) {
  var _a, _b;
  var _c9 = useDayPicker(), dir = _c9.dir, locale = _c9.locale, classNames = _c9.classNames, styles = _c9.styles, _d = _c9.labels, labelPrevious2 = _d.labelPrevious, labelNext2 = _d.labelNext, components = _c9.components;
...
function SelectSingleProviderInternal(_a) {
  ...
  var onDayClick = function(day, activeModifiers, e) {
    ...
    (_c9 = initialProps.onSelect) === null || _c9 === void 0 ? void 0 : _c9.call(initialProps, day, day, activeModifiers, e);
  };
  var contextValue = {
...
function useDayEventHandlers(date, activeModifiers) {
  ...
  var onClick = function(e) {
    ...
    if (isDayPickerSingle(dayPicker)) {
      ...
      (_c9 = range.onDayClick) === null || _c9 === void 0 ? void 0 : _c9.call(range, date, activeModifiers, e);
    } else {
...
function useDayRender(day, displayMonth, buttonRef) {
  ...
  var DayContentComponent = (_c9 = (_b = dayPicker.components) === null || _b === void 0 ? void 0 : _b.DayContent) !== null && _c9 !== void 0 ? _c9 : DayContent;
...
function Row(props) {
  var _a, _b;
  var _c9 = useDayPicker(), styles = _c9.styles, classNames = _c9.classNames, showWeekNumber = _c9.showWeekNumber, components = _c9.components;
...
function Table(props) {
  ...
  var FooterComponent = (_c9 = components === null || components === void 0 ? void 0 : components.Footer) !== null && _c9 !== void 0 ? _c9 : Footer;
...
function Root(_a) {
  ...
  var MonthsComponent = (_c9 = (_b = initialProps.components) === null || _b === void 0 ? void 0 : _b.Months) !== null && _c9 !== void 0 ? _c9 : Months;
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1725348296789.579";
}
function Calendar({
  className,
  classNames,
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(DayPicker, { showOutsideDays, className: cn("p-3", className), classNames: {
...
// app/components/apartments/apartment-pick/date-picker-with-range.tsx
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  prevRefreshSig = window.$RefreshSig$;
  window.$RefreshReg$ = (type, id2) => {
    window.$RefreshRuntime$.register(type, '"app/components/apartments/apartment-pick/date-picker-with-range.tsx"' + id2);
  };
  window.$RefreshSig$ = window.$RefreshRuntime$.createSignatureFunctionForTransform;
}
var prevRefreshReg;
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1725532831669.772";
}
var DatePickerWithRange = ({
  onChange,
  selectedDates,
  bookedDates
}) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)("div", { className: cn("flex flex-col items-center p-4 bg-white shadow-md rounded-lg w-full h-full"), children: /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)("div", { className: "w-full h-full max-w-md mb-4", children: /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(Calendar, { mode: "range", className: "h-full w-full flex", defaultMonth: selectedDates?.from, selected: selectedDates, onSelect: handleDateChange, disabled: isDateDisabled, classNames: {
    ...
    fileName: "app/components/apartments/apartment-pick/date-picker-with-range.tsx",
    lineNumber: 79,
    columnNumber: 9
  }, this) }, void 0, false, {
    fileName: "app/components/apartments/apartment-pick/date-picker-with-range.tsx",
...
_c6 = DatePickerWithRange;
var _c6;
$RefreshReg$(_c6, "DatePickerWithRange");
window.$RefreshReg$ = prevRefreshReg;
window.$RefreshSig$ = prevRefreshSig;

// app/components/apartments/apartment-pick/date-selection-section.tsx
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  prevRefreshSig = window.$RefreshSig$;
  window.$RefreshReg$ = (type, id2) => {
    window.$RefreshRuntime$.register(type, '"app/components/apartments/apartment-pick/date-selection-section.tsx"' + id2);
  };
  window.$RefreshSig$ = window.$RefreshRuntime$.createSignatureFunctionForTransform;
}
var prevRefreshReg;
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1725543064262.625";
}
var DateSelectionSection = ({
  onChange,
  selectedDates,
  bookedDates
}) => {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)("div", { className: "p-6 bg-blue-50 rounded-lg shadow-md flex flex-col max-h-[75vh] overflow-hidden", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)("div", { className: "w-full flex justify-between", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)("h2", { className: "text-2xl font-semibold mb-4 text-gray-700", children: "Select Your Dates" }, void 0, false, {
        fileName: "app/components/apartments/apartment-pick/date-selection-section.tsx",
        lineNumber: 31,
        columnNumber: 9
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)(Button, { size: "lg", onClick: () => onChange(void 0), children: [
        "Reset",
        /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)(ResetIcon, { className: "ml-2 h-5 w-5" }, void 0, false, {
          fileName: "app/components/apartments/apartment-pick/date-selection-section.tsx",
          lineNumber: 36,
          columnNumber: 11
        }, this)
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)("div", { className: "flex-1 overflow-y-auto", children: /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)(DatePickerWithRange, { onChange, selectedDates, bookedDates }, void 0, false, {
      fileName: "app/components/apartments/apartment-pick/date-selection-section.tsx",
      lineNumber: 41,
      columnNumber: 9
    }, this) }, void 0, false, {
...
_c7 = DateSelectionSection;
var _c7;
$RefreshReg$(_c7, "DateSelectionSection");
window.$RefreshReg$ = prevRefreshReg;
window.$RefreshSig$ = prevRefreshSig;

// app/graphql/queries/get-apartments.ts
if (import.meta) {
  import.meta.hot = createHotContext(
    //@ts-expect-error
    "app/graphql/queries/get-apartments.ts"
  );
  import.meta.hot.lastModified = "1725461620659.853";
}
var GET_APARTMENTS = gql`
  query GetApartments {
    apartments {
      id
      name
...
// app/hooks/use-get-apartments.ts
if (import.meta) {
  import.meta.hot = createHotContext(
    //@ts-expect-error
    "app/hooks/use-get-apartments.ts"
  );
  import.meta.hot.lastModified = "1725530439741.7183";
}
var useGetApartments = () => {
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  prevRefreshSig = window.$RefreshSig$;
  window.$RefreshReg$ = (type, id2) => {
    window.$RefreshRuntime$.register(type, '"app/routes/app.apartment-pick.tsx"' + id2);
  };
  window.$RefreshSig$ = window.$RefreshRuntime$.createSignatureFunctionForTransform;
}
var prevRefreshReg;
...
function ApartmentPickPage() {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime8.jsxDEV)("div", { className: "flex flex-col h-full", children: [
...
var _c8;
$RefreshReg$(_c8, "ApartmentPickPage");
window.$RefreshReg$ = prevRefreshReg;
window.$RefreshSig$ = prevRefreshSig;
export {
